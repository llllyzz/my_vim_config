...
## why did I init set up this vim config?

- I often need vim to edit bash scripts on remote nodes.
- Vim works reliably across all platforms.
- While I primarily use Vscode on my local machine, there are times when I still need vim.
